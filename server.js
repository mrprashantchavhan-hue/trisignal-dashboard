...
const STOCKS = [
  ...
  {s:'HDFCLIFE', n:'HDFC Life Insurance', sec:'Insurance'},  // Expanded F&O Coverage (High Volume / Liquidity)
  ...
  const fetchTask = (async () => {
    ...
    try {
      ...
      for (let i = 0; i < list.length; i += chunkSize) {
        ...
        await new Promise(r => setTimeout(r, 500)); // Larger breather between chunks
      }
